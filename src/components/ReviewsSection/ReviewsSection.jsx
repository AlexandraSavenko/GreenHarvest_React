...
export default function ReviewsSection () {
    ...
    >
      <SwiperSlide className={css.slide}>
        <img src={John_min} alt="John Wax shares his oppinion" />
        <h3>John Wax</h3>
      ...
      <SwiperSlide className={css.slide}>
        <img src={Victoria_min} alt="Victoria Romashenko shares his oppinion" />
      ...
      <SwiperSlide className={css.slide}>
        <img src={Ihor_min} alt="Ihor Trachuk shares his oppinion" />
        <h3>Ihor Trachuk</h3>
